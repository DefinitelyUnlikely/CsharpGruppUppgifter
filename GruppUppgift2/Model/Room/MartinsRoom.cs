...
public class MartinsRoom
{
    ...
    {
        new GameObject("chair", "An old chair. As you inspect it closer, you can tell it is marked with the inscription 'Made in 1802'"),
        new GameObject("bookcase", "As you take a closer look at the bookcase, you realize none of the books have titles, except one. George Orwell's <1984>."),

        new BrokenClock("clock", "A broken clock. You notice there is a keyhole in the middle of it.",
        ...
        new LibraryBook("1984", "As you pick up the book, you notice it is lighter than it probably should be. You open it up, revealing a hidden key."),
    };
