public class CombinationPadlock : UsableItem
{
    ...
    public CombinationPadlock(string name, string description, string combination, string? useDescription = null, List<GameObject>? useWith = null, Dictionary<GameObject, string>? usableWithDescriptions = null)
